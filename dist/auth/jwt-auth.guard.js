...
let JwtAuthGuard = class JwtAuthGuard extends (0, passport_1.AuthGuard)('jwt') {
    constructor(reflector, usuariosService) {
        super();
    ...
    canActivate(context) {
        ...
        return (0, rxjs_1.of)(canActivate).pipe((0, operators_1.mergeMap)((value) => value), (0, operators_1.takeWhile)((value) => value), (0, operators_1.map)(() => context.switchToHttp().getRequest()), (0, operators_1.mergeMap)((request) => (0, rxjs_1.of)(request).pipe((0, operators_1.map)((req) => {
            ...
            return req.user;
        }), (0, operators_1.mergeMap)((usuarioFromJwt) => this.usuariosService.findById(usuarioFromJwt.id)), (0, operators_1.tap)((usuario) => {
...
JwtAuthGuard = __decorate([
    ...
    __param(1, (0, common_1.Inject)(usuarios_service_1.UsuariosService)),
