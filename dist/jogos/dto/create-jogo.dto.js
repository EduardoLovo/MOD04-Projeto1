...
const create_genero_dto_1 = require("../../generos/dto/create-genero.dto");
const create_perfi_dto_1 = require("../../perfis/dto/create-perfi.dto");
const jogo_entity_1 = require("../entities/jogo.entity");
class CreateJogoDto extends jogo_entity_1.Jogo {
}
__decorate([
